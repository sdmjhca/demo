...
public class EventBusMain {
    public static void main(String[] args) {
        ...
        eb.consumer("com.sdmjhca.ca",message -> {
            ...
            System.out.println("接收到的消息="+message.body());

            message.reply("回复给发送者的消息= hello");
        ...
        //定义消息的编解码器
        MessageCodec messageCodec = new MessageCodecTest();
        ...
        //点对点发送消息
        eb.send("com.sdmjhca.ca","点对点消息只有一个处理器能收到",req->{
            if(req.succeeded()){
